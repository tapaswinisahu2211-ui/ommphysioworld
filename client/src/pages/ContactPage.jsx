...
const copy = {
  en: {
    ...
    iframeTitle: "OmmPhysio World location map",
  },
  hi: {
    eyebrow: "संपर्क",
    title: "क्लिनिक तक आसानी से पहुंचें और अपनी विजिट आत्मविश्वास से प्लान करें।",
    text: "चाहे आपको सही थेरेपी सेवा चुनने में मदद चाहिए या क्लिनिक का समय जानना हो, हम आपकी सहायता के लिए यहां हैं।",
    cards: [
      { title: "क्लिनिक पता", detail: "सिटी क्लिनिक रोड, दवाइंडिया के पास, देउलसाही, भंजपुर, बारिपदा, ओडिशा 757001" },
      { title: "संपर्क विवरण", detail: "+91 88955 55519 / contact@ommphysioworld.com" },
      { title: "डॉक्टर", detail: "डॉ. तपस्विनी साहू" },
      { title: "कार्य समय", detail: "सोमवार से शनिवार, सुबह 9:00 बजे से शाम 7:00 बजे तक" },
    ],
    directionsTitle: "रास्ता चाहिए?",
    directionsText: "तेज़ नेविगेशन के लिए मैप का उपयोग करें या Google Maps में क्लिनिक का सटीक स्थान खोलें।",
    openMaps: "Google Maps में खोलें",
    findUs: "हमें खोजें",
    mapTitle: "लाइव मैप दिशा-निर्देश के साथ क्लिनिक आएं",
    iframeTitle: "ओमफिजियो वर्ल्ड लोकेशन मैप",
  },
  or: {
    eyebrow: "ଯୋଗାଯୋଗ",
    title: "କ୍ଲିନିକକୁ ସହଜରେ ପହଞ୍ଚନ୍ତୁ ଏବଂ ଆପଣଙ୍କ ଭିଜିଟ୍ ନିଶ୍ଚିତତା ସହ ପ୍ଲାନ କରନ୍ତୁ।",
    text: "ଠିକ୍ ଥେରାପି ସେବା ଚୟନ କରିବାରେ ସାହାଯ୍ୟ ଦରକାର ହେଉ କିମ୍ବା କ୍ଲିନିକର ସମୟ ନିଶ୍ଚିତ କରିବାକୁ ଚାହୁଁଥିଲେ, ଆମେ ସହାୟତା ପାଇଁ ଏଠାରେ ଅଛୁ।",
    cards: [
      { title: "କ୍ଲିନିକ ଠିକଣା", detail: "ସିଟି କ୍ଲିନିକ ରୋଡ୍, ଦବାଇଣ୍ଡିଆ ପାଖରେ, ଦେଉଲସାହି, ଭଞ୍ଜପୁର, ବାରିପଦା, ଓଡିଶା 757001" },
      { title: "ଯୋଗାଯୋଗ ବିବରଣୀ", detail: "+91 88955 55519 / contact@ommphysioworld.com" },
      { title: "ଡାକ୍ତର", detail: "ଡା. ତପସ୍ୱିନୀ ସାହୁ" },
      { title: "କାର୍ଯ୍ୟ ସମୟ", detail: "ସୋମବାରରୁ ଶନିବାର, ସକାଳ 9:00 ରୁ ସନ୍ଧ୍ୟା 7:00 ପର୍ଯ୍ୟନ୍ତ" },
    ],
    directionsTitle: "ରାସ୍ତା ଦରକାର କି?",
    directionsText: "ତ୍ୱରିତ ନାଭିଗେସନ ପାଇଁ ମାପ୍ ବ୍ୟବହାର କରନ୍ତୁ କିମ୍ବା Google Maps ରେ ଠିକ୍ କ୍ଲିନିକ ଅଞ୍ଚଳ ଖୋଲନ୍ତୁ।",
    openMaps: "Google Maps ରେ ଖୋଲନ୍ତୁ",
    findUs: "ଆମକୁ ଖୋଜନ୍ତୁ",
    mapTitle: "ଲାଇଭ୍ ମାପ୍ ଦିଗନିର୍ଦ୍ଦେଶ ସହିତ କ୍ଲିନିକକୁ ଆସନ୍ତୁ",
    iframeTitle: "ଓମ୍‌ଫିଜିଓ ୱାର୍ଲ୍ଡ ଲୋକେସନ ମାପ୍",
  },
};
...
export default function ContactPage() {
  ...
  return (
    <PublicLayout>
      <Seo
        title="Contact OmmPhysio World in Baripada"
        description="Contact OmmPhysio World physiotherapy clinic in Baripada for appointments, directions, clinic timings, and therapy guidance."
        path="/contact"
        schema={[
          createMedicalBusinessSchema({
            description:
              "Contact details, map, and clinic timings for the OmmPhysio World physiotherapy clinic in Baripada.",
            path: "/contact",
            pageName: "Contact",
          }),
