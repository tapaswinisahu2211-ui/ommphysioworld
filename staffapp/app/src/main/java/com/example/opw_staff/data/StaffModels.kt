...
val staffModuleTemplates = listOf(
    ...
    ModuleTemplate("archived_patients", "Archived Patients", view = false, add = false, edit = false),
    ModuleTemplate("appointments", "Appointments", view = true, add = true, edit = true),
    ModuleTemplate("treatment_plans", "Treatment Plans", view = true, add = true, edit = true),
    ModuleTemplate("clinical_notes", "Clinical Notes", view = true, add = true, edit = true),
    ModuleTemplate("therapy_recommendations", "Therapy Recommendations", view = true, add = true, edit = true),
    ModuleTemplate("payments", "Payments", view = true, add = true, edit = true),
    ...
    ModuleTemplate("feedback", "Feedback", view = false, add = false, edit = false),
